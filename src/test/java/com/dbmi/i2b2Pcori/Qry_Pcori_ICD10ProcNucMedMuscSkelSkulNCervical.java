...
public class Qry_Pcori_ICD10ProcNucMedMuscSkelSkulNCervical extends LoginI2b2Pcori {

	@Test(groups = { "UI_query" })
	public String qryICD10ProcNucMedMuscSkelSkulNCervical() throws Exception {
		testLogin();
		Reporter.log(
				"Query: ICD10 Procedures/Nuclear medicine (procedure)/musculoskeletal system (procedure)/cervical spine");
...
//		Tomographic
		...
		// Scroll down
				...
				+ "\\ skull and cervical spine - ICD10PCS:CP23']/div"));
	...
	public void testCompare() throws Exception {
		if (!qryICD10ProcNucMedMuscSkelSkulNCervical().contains(testDB())) {
	...
	public String testDB() throws ClassNotFoundException, SQLException {
		return Connect2DB("select count(distinct patient_num) from observation_fact "
				...
				+ "Nuclear m~uso4\\(CP2) Nuclear~vlcm\\(CP23) Nuclear~29ts\\%') ");
	}
