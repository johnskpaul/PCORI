...
public class Qry_Pcori_DemHispanicY extends LoginI2b2Pcori {


	@Test(groups = { "UI_query" })
	public String qryDemHispanicY() throws Exception {
		testLogin();
		Reporter.log("Query: Demographics/Hispanic = Yes");
		// Demographics
...
//				.findElement(By.xpath(".//*[@title='Demographic \\ Race \\ White - DEM|RACE:W']/div"));
	...
	public void testCompare() throws Exception {
		if (!qryDemHispanicY().contains(testDB())) {
	...
	public void DBduration() throws Exception {
		testDB_duration("insert into "
				+ "dev02i2b2demodata.QUERY_GLOBAL_TEMP (patient_num, panel_count) with t as (select  /*+ index(observation_fact fact_cnpt_pat_enct_idx) */ f.patient_num from "
