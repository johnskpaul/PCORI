...
public class Qry_Pcori_ICD10ProcNucMedMuscSkelCervicalSpine extends LoginI2b2Pcori {

	@Test(groups = { "UI_query" })
	public String qryICD10ProcNucMedMuscSkelCervicalSpine() throws Exception {
		testLogin();
		Reporter.log(
...
//		Musculoskeletal system
	...
	public void testCompare() throws Exception {
		if (!qryICD10ProcNucMedMuscSkelCervicalSpine().contains(testDB())) {
