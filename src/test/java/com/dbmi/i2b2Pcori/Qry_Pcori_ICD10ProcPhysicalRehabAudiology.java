...
public class Qry_Pcori_ICD10ProcPhysicalRehabAudiology extends LoginI2b2Pcori {
...
// 		Physical rehabilitation and diagnostic audiology (procedure) 
				...
				".//*[@title='ICD10PCS_2015AA \\ Physical rehabilitation and "
				+ "diagnostic audiology (procedure) - ICD10PCS:F']/div"));
	...
	public String testDB() throws ClassNotFoundException, SQLException {
		return Connect2DB("select count(distinct patient_num) from observation_fact "
				...
				+ "where CONCEPT_PATH like '\\ICD10PCS_2015AA\\(F) Physical r~vf8d\\%') ");
	}
	...
	public void DBduration() throws Exception {
		testDB_duration(
				...
				+ "where concept_path LIKE '\\ICD10PCS?_2015AA\\(F) Physical r~vf8d\\%' {ESCAPE '?'} ) "
